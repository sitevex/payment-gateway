...
@component('components.organisms.modal_mesaje', [
  ...
  'modalFooter' => '<button type="button" class="btn btn-lg btn-dark-zc fw-bold w-100" data-bs-dismiss="modal">Aceptar</button>'
])
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-body-tertiary">Por favor, introduce tu número de identificación para acceder a tus pedidos</p>
                        </div>
                        <form class="row g-3 needs-validation" novalidate action="#" method="post" id="rucForm">
                            @csrf
                            <div class="col-md-12">
                                <label for="numeroIdentificacion" class="form-label fs-sm d-none">Número de idetificación</label>
                                <input type="number" class="form-control form-control-lg" name="numeroIdentificacion" id="numeroIdentificacion" placeholder="Ingresa tu número de identificación (ruc)" required />
...
<script>
    ...
    document.getElementById('rucForm').addEventListener('submit', function(event) {
